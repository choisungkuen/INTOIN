...
public class SubHeaderHolder extends TreeNode.BaseNodeViewHolder<MainTreeItemHolder.IconTreeItem> {

    private PrintView arrowView;

    public SubHeaderHolder(Context context) {
        super(context);
    }
    ...
    public View createNodeView(TreeNode node, MainTreeItemHolder.IconTreeItem value) {
        ...
        final View view = inflater.inflate(R.layout.customer_sub_header_row, null, false);
