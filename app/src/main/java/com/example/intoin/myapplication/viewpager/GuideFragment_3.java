...
public class GuideFragment_3 extends Fragment {
    ...
    public static GuideFragment_3 newInstance(int layout) {
        GuideFragment_3 fragment = new GuideFragment_3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.guide3_fragment, container, false);
