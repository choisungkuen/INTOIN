...
public class GuideFragment_2 extends Fragment {
    ...
    public static GuideFragment_2 newInstance(int layout) {
        GuideFragment_2 fragment = new GuideFragment_2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.guide2_fragment, container, false);
